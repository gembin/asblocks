...
public class TestForStatement extends AbstractStatementTest
{
	...
	public function testSimpleFor():void
	{
		...
		assertStatement("1", input,
			...
			"column=\"14\">int</type><init line=\"1\" column=\"20\"><number " +
			"line=\"1\" column=\"20\">0</number></init></name-type-init></var-list>" +
			"</init><cond line=\"1\" column=\"23\"><relation line=\"1\" " +
			"column=\"23\"><primary line=\"1\" column=\"23\">i</primary>" +
			"<op line=\"1\" column=\"25\">&lt;</op><primary line=\"1\" column=\"27\">" +
			"length</primary></relation></cond><iter line=\"1\" column=\"35\">" +
	...
	public function testSimpleForEach():void
	{
		...
		assertStatement("1", input,
			...
			"line=\"1\" column=\"39\">obj</primary><call line=\"1\" column=\"48\">" +
			"<primary line=\"1\" column=\"43\">print</primary><arguments " +
			"line=\"1\" column=\"48\"><primary line=\"1\" column=\"50\">i" +
			"</primary></arguments></call></dot></block></foreach>");
		...
		assertStatement("3", input,
			...
			"</name-type-init></var><in line=\"1\" column=\"21\"><dot line=\"1\" " +
			"column=\"27\"><primary line=\"1\" column=\"24\">xml</primary>" +
			"<e4x-descendent line=\"1\" column=\"37\"><primary line=\"1\" " +
	...
	public function testSimpleForIn():void
	{
		...
		assertStatement("1", input,
			...
			"line=\"1\" column=\"14\">String</type></name-type-init></var-list>" +
			"</init><in line=\"1\" column=\"21\"><primary line=\"1\" " +
			...
			"<primary line=\"1\" column=\"46\">s</primary></arr-acc>" +
			"</arguments></call></block></forin>");
