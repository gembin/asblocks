...
public class TestForEachInStatementNode extends BaseASFactoryTest
{
	private var block:IBlock;
	
	private var statement:IForEachInStatement;
	...
	{
		block = factory.newBlock();
		statement = block.addStatement("for each (foo in bar) { }") as IForEachInStatement;
