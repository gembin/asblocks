...
import org.teotigraphix.as3blocks.api.IScriptFragmentNode;
 ...
 * @productversion 1.0
 */
public class ScriptFragmentNode implements IScriptFragmentNode
{
	//--------------------------------------------------------------------------
	//
	//  Properties
	 ...
	 * Constructor.
	 */
	public function ScriptFragmentNode(node:IParserNode)
	{
		_node = node;
	}
